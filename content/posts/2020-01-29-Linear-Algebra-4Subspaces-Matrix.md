...
![矩阵$A$的行向量组成的空间（平面）以及零向量（线）](/images/rowSpace.png)
...
![矩阵$A$的列向量组成的空间（平面）以及左零空间](/images/colunmSpace.png)
...
[2023-11-30] 这篇文章是三年前写成的，经过三年在机器人控制和视觉项目上的体会，整体的框架不变，更多的是在工程中体会到需要很恰当地选择好坐标系统，在这样的系统中可以很方便地去表达向量或者是状态，例如我能想到的就是在对控制系统建模的时候，一阶微分方程(忽略控制量的影响)
$$
\dot x = Ax
$$
...
<iframe width="100%" height="800" src="/images/The-Art-of-Linear-Algebra.pdf">
