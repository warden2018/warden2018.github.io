...
![安装界面](/images/Chat_with_RTX_install.png)

一路点击下一步安装即可。

![安装界面2](/images/Chat_with_RTX_install2.png)
...
![加参数](/images/Chat_with_RTX_share_params.png)


## 运行

![加载模型和参数](/images/Chat_with_RTX_install_running.png)

![根据路径下文件内容生成embeddings](/images/Chat_with_RTX_install_running_finish.png)

这里有一个问题就是：如果我的数据库当中增加或者减少文件，需要重新生成embeddings,这个过程很慢。

![GPU运行情况](/images/Chat_with_RTX_GPU.png)

## 问问题
由于我第一次指定的`path`下文件数量很大，导致无法全部加载成功，我减少文件数量，单独加载一个关于bike fitting的书。

![测试](/images/Chat_with_RTX_test.png)


![基础比例对判断的影响](/images/Chat_with_RTX_cabs_accidents1.png)

![使用贝叶斯定理计算概率1](/images/Chat_with_RTX_cabs_accidents2.png)

![使用贝叶斯定理计算概率2](/images/Chat_with_RTX_cabs_accidents3.png)
